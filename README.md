...
This project focused on modernizing a legacy e-commerce system into a scalable cloud-native platform capable of:
- supporting vendor and customer workflows
- improving search performance across large product inventories
- enabling subscription-based business operations
- handling promotional campaigns and seasonal traffic spikes
- improving deployment reliability and long-term maintainability

Instead of only rebuilding features, the primary engineering focus was improving scalability, maintainability, search efficiency, and production stability.
...
**Cloud:** Microsoft Azure (App Services, Azure Functions, Azure SQL)  
